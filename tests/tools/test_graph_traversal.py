...
@pytest.mark.slow
def test_find_ast_node_with_text_in_file_with_basename(neo4j_container_with_kg_fixture):  # noqa: F811
  neo4j_container, _ = neo4j_container_with_kg_fixture
...
@pytest.mark.slow
def test_find_ast_node_with_text_in_file_with_relative_path(neo4j_container_with_kg_fixture):  # noqa: F811
  neo4j_container, _ = neo4j_container_with_kg_fixture
...
@pytest.mark.slow
def test_find_ast_node_with_type_in_file_with_basename(neo4j_container_with_kg_fixture):  # noqa: F811
  neo4j_container, _ = neo4j_container_with_kg_fixture
...
@pytest.mark.slow
def test_find_ast_node_with_type_in_file_with_relative_path(neo4j_container_with_kg_fixture):  # noqa: F811
  neo4j_container, _ = neo4j_container_with_kg_fixture
...
@pytest.mark.slow
def test_preview_file_content_with_basename(neo4j_container_with_kg_fixture):  # noqa: F811
  neo4j_container, _ = neo4j_container_with_kg_fixture
...
@pytest.mark.slow
def test_preview_file_content_with_relative_path(neo4j_container_with_kg_fixture):  # noqa: F811
  neo4j_container, _ = neo4j_container_with_kg_fixture
  ...
  with neo4j_container.get_driver() as driver:
    result = graph_traversal.preview_file_content_with_relative_path(relative_path, driver, 1000)
...
@pytest.mark.slow
def test_read_code_with_basename(neo4j_container_with_kg_fixture):  # noqa: F811
  neo4j_container, _ = neo4j_container_with_kg_fixture
  ...
  for result_row in result_data:
    ...
    assert "public static void main(String[] args) {" in result_row["SelectedLines"].get("text", "")
    assert "FileNode" in result_row
    assert result_row["FileNode"].get("basename", "") == basename


@pytest.mark.slow
def test_read_code_with_relative_path(neo4j_container_with_kg_fixture):  # noqa: F811
  neo4j_container, _ = neo4j_container_with_kg_fixture
