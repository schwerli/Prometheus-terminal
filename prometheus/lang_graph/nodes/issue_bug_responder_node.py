...
- Bug Context: Generated by our analysis agent that investigated and understood the issue
...
- Reference the system's understanding of the issue (from bug_context)
