...
class IssueAnswerService:
  ...
  def _initialize_issue_subgraph(self):
    if self.kg_service.kg is not None:
      self.issue_answer_subgraph = IssueAnswerSubgraph(
        self.model,
        self.kg_service.kg,
      ...
      self.issue_answer_subgraph = None
